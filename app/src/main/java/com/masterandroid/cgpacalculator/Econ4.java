...
public class Econ4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_econ4);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sc2.isEmpty() || sc3.isEmpty() || sa2.isEmpty() || sa3.isEmpty() || sb2.isEmpty() || sb3.isEmpty() || sd2.isEmpty() || sd3.isEmpty() || se2.isEmpty() || se3.isEmpty() || sf2.isEmpty() || sf3.isEmpty() || sg.isEmpty() || sh.isEmpty() || si.isEmpty()){
                    ...
                    //a2.requestFocus();
                    Toast.makeText(Econ4.this,"Please Enter Marks!",Toast.LENGTH_SHORT).show();
                }else
                {
                    ...
                    if ((0 > fg) || (fg > 100)) {
                        ...
                        float h = (float) (((fh / 10) + 1) * 1.5);
                        int i = (fi / 10) + 1;
                        //float m = 0;
                        //float gpa = 0;
                        float m = a + b + c + d + e + f + g + h + i;
                        float gpa = (float) (m / 23.5);

...
public class Csse5 extends AppCompatActivity {

    EditText a1, a2, a3, b1, b2, b3, c1, c2, c3, d1, d2, d3, e1, e2, e3, f1, f2, f3, g, h;
    Button bt1, bt2;
    TextView x;
    TextView y;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csse5);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sc2.isEmpty() || sc3.isEmpty() || sa2.isEmpty() || sa3.isEmpty() || sb2.isEmpty() || sb3.isEmpty() || sd2.isEmpty() || sd3.isEmpty() || se2.isEmpty() || se3.isEmpty() || sf2.isEmpty() || sf3.isEmpty() || sg.isEmpty() || sh.isEmpty()){
                    // a2.setError("Please enter marks");
                    //a2.requestFocus();
                    Toast.makeText(Csse5.this,"Please Enter Marks!",Toast.LENGTH_SHORT).show();
                }else
                {

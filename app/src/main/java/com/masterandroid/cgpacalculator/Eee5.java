...
public class Eee5 extends AppCompatActivity {

    EditText a1, a2, a3, b1, b2, b3, c1, c2, c3, d1, d2, d3, e1, e2, e3, f1, f2, f3, g, h, i;
    Button bt1, bt2;
    TextView x;
    TextView y;
    TextView o1, o2, o3, o4, o5, o6, o7, o8, o9;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eee5);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sc2.isEmpty() || sc3.isEmpty() || sa2.isEmpty() || sa3.isEmpty() || sb2.isEmpty() || sb3.isEmpty() || sd2.isEmpty() || sd3.isEmpty() || se2.isEmpty() || se3.isEmpty() || sf2.isEmpty() || sf3.isEmpty() || sg.isEmpty() || sh.isEmpty() || si.isEmpty()){
                    // a2.setError("Please enter marks");
                    //a2.requestFocus();
                    Toast.makeText(Eee5.this,"Please Enter Marks!",Toast.LENGTH_SHORT).show();
                }else
                {
                    ...
                    if ((0 > fg) || (fg > 100)) {
                        ...
                        int e = ((ef / 10) + 1) * 4;
                        int f = ((ff / 10) + 1) * 4;
                        float g = (float) (((fg / 10) + 1) * 1);
                        float h = (float) (((fh / 10) + 1) * 1);
                        float i = (float) (((fi / 10) + 1) * 1.5);
                        //float m = 0;
                        //float gpa = 0;
                        float m = a + b + c + d + e + f + g + h + i;
                        float gpa = (float) (m / 24.5);

...
public class First extends AppCompatActivity {
    ...
    EditText a1, a2, a3, b1, b2, b3, c1, c2, c3, d1, d2, d3, g, h, i, j;
    Button bt1, bt2;
    TextView x;
    TextView y;
    TextView o1, o2, o3, o4, o7, o8, o9, o10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(sc2.isEmpty() || sc3.isEmpty() || sa2.isEmpty() || sa3.isEmpty() || sb2.isEmpty() || sb3.isEmpty() || sd2.isEmpty() || sd3.isEmpty() || sg.isEmpty() || sh.isEmpty() || si.isEmpty() || sj.isEmpty()){
                    // a2.setError("Please enter marks");
                    //a2.requestFocus();
                    Toast.makeText(First.this,"Please Enter Marks!",Toast.LENGTH_SHORT).show();
                }else
                {
